...
background_image = pygame.image.load("puzzle.webp")
...
# Button positions
START_RECT = pygame.Rect(win_width//2 - 100, win_height//2 - 50, 230, 50)
QUIT_RECT = pygame.Rect(win_width//2 - 100, win_height//2 + 20, 230, 50)

def draw_home_screen():
    DISPLAYSURF.blit(background_image, (0, 0))
    pygame.draw.rect(DISPLAYSURF, WHITE, START_RECT)
    pygame.draw.rect(DISPLAYSURF, WHITE, QUIT_RECT)
    
    start_text = BASICFONT.render("Start Game", True, TEXTCOLOR)
    quit_text = BASICFONT.render("Quit", True, TEXTCOLOR)
    
    DISPLAYSURF.blit(start_text, (START_RECT.x + 40, START_RECT.y + 10))
    DISPLAYSURF.blit(quit_text, (QUIT_RECT.x + 75, QUIT_RECT.y + 10))
...
def main():
    ...
    NEXT_LEVEL_COLOR = WHITE
    NEXT_LEVEL_SURF, NEXT_LEVEL_RECT = makeText('Next Level', GREEN, NEXT_LEVEL_COLOR, BASICFONT, win_width - 150, win_height - 250)
